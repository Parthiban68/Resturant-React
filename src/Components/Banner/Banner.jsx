    ...
    return (
        <div className='container py-14 relative'>
            <div className='relative z-20'>
                <h1  data-aos='fade-up' data-aos-delay="300" className='py-8 tracking-wider text-2xl font-semibold text-dark text-center'>Taste and Healthy Difference</h1>
            </div>
            <div className='space-y-10'>
                <div data-aos='fade-up' data-aos-delay="300" className='grid gird-cols-1 sm:grid-cols-2 gap-4 py-10 '>
                    <div>
            ...
            <div className='absolute top-9 sm:bottom-0 sm:left-0 opacity-50 sm:opacity-100'>
                <img data-aos='fade-right' data-aos-delay="300" src={leaf} alt="" className='max-w-[160px]' />
            </div>
            <div className='absolute top-[16rem] left-24 sm:-bottom-0 sm:left-0 opacity-50 sm:opacity-100'>
                <img data-aos='fade-right' data-aos-delay="300" src={tomato} alt="" className='max-w-[380px]'/>
            </div>
            <div className='absolute top-[6rem]  -right-[-190px] sm:right-10 opacity-50 sm:opacity-100'>
                <img data-aos='fade-left' data-aos-delay="300"   src={lemon} alt="" className='max-w-[240px]' />
            </div>
            <div className='absolute bottom-60 right-[10rem] opacity-50 sm:bottom-60 sm:right-[10rem] sm:opacity-100'>
                <img data-aos='fade-left' data-aos-delay="300"  src={apple} alt="" className='max-w-[3800px]'/>
            </div>
            <div className='absolute bottom-0 opacity-50 sm:opacity-100 sm:bottom-28'>
                <img data-aos='fade-right' data-aos-delay="300"  src={kiwi} alt="" className='max-w-[380px]'/>
            </div>
        </div>
    )
}
